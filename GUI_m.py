...
class StartPage(Frame):
    ...
    def __init__(self, parent, controller):
        ...
        button_2=Button(self,text='Real-Time Interaction',width=20,command=self.Interaction)
...
class PageOne(Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label1_1.pack(pady=(5,0))

        label_frame1 = LabelFrame(self,text='Feature Extraction', width=247,heigh=275,bd=3)
        label_frame1.place(x=8,y=30)

        label_frame2 = LabelFrame(self,text='Training Model',width=247,heigh=275,bd=3)
        label_frame2.place(x=262,y=30)
        ...
        R11= Radiobutton(label_frame1,text='Vecterized Landmarks Only (VL)',value=11,variable=self.v1)
        R11.pack(anchor=W)
        R12= Radiobutton(label_frame1,text='Action Unit Only (AU)',value=12,variable=self.v1)
        R12.pack(anchor=W)
        R13= Radiobutton(label_frame1,text='Both Two (VL+AU)',value=13,variable=self.v1)
        R13.pack(anchor=W,pady=(0,10))
        R13.invoke() # default choice

        label2_2 = Label(label_frame1,text='The Number of Action Unit')
        ...
        label2_8 = Label(label_frame1, text='m =')
        label2_8.place(x=42,y=158)
        ...
        label2_7 = Label(label_frame1,text='AU for')
